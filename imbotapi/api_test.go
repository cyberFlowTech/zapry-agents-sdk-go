...
func TestSetWebhookWithCert(t *testing.T) {
	...
	wh, err := NewWebhookWithCert("https://example.com/imbotapi-test/"+bot.Token, FilePath("tests/cert.pem"))
...
func TestSetWebhookWithoutCert(t *testing.T) {
	...
	wh, err := NewWebhook("https://example.com/imbotapi-test/" + bot.Token)
...
func TestSendWithMediaGroupPhotoVideo(t *testing.T) {
	...
	cfg := NewMediaGroup(ChatID, []interface{}{
		NewInputMediaPhoto(FileURL("https://github.com/imbot-io/imbot-sdk-go/raw/0a3a1c8716c4cd8d26a262af9f12dcbab7f3f28c/tests/image.jpg")),
